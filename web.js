...
;
	($.$idle_app_dps) = class $idle_app_dps extends ($.$mol_page) {
		auto_attack(){
			return null;
		}
		money_title(){
	...
	($mol_mem(($.$idle_app_dps.prototype), "Money"));
	($mol_mem(($.$idle_app_dps.prototype), "Damage"));
	($mol_mem(($.$idle_app_dps.prototype), "Stats_row"));
	($mol_mem(($.$idle_app_dps.prototype), "Enemy"));
	($mol_mem(($.$idle_app_dps.prototype), "Enemy_level"));
	($mol_mem(($.$idle_app_dps.prototype), "Enemy_health"));
	($mol_mem(($.$idle_app_dps.prototype), "Ememy_row"));
	($mol_mem(($.$idle_app_dps.prototype), "attack_enemy"));
	($mol_mem(($.$idle_app_dps.prototype), "Attack_enemy"));
	($mol_mem(($.$idle_app_dps.prototype), "Action_row"));
	($mol_mem(($.$idle_app_dps.prototype), "skill_x10"));
	($mol_mem(($.$idle_app_dps.prototype), "Dmg_x10"));
	($mol_mem(($.$idle_app_dps.prototype), "auto_checked"));
	($mol_mem(($.$idle_app_dps.prototype), "Auto_attack"));
	($mol_mem(($.$idle_app_dps.prototype), "Skills_row"));
	($mol_mem(($.$idle_app_dps.prototype), "damage_up_title"));
	($mol_mem(($.$idle_app_dps.prototype), "damage_up_enabled"));
	($mol_mem(($.$idle_app_dps.prototype), "damage_up"));
	($mol_mem(($.$idle_app_dps.prototype), "Damage_up"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $idle_app_dps.prototype, "money", null);
        __decorate([
            $mol_mem
        ], $idle_app_dps.prototype, "health", null);
        __decorate([
            $mol_mem
        ], $idle_app_dps.prototype, "level", null);
        __decorate([
            $mol_mem
        ], $idle_app_dps.prototype, "auto_attack", null);
        __decorate([
            $mol_mem
        ], $idle_app_dps.prototype, "damage_level", null);
        $$.$idle_app_dps = $idle_app_dps;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$idle_app) = class $idle_app extends ($.$mol_book2_catalog) {
		...
		Dps_page(){
			const obj = new this.$.$idle_app_dps();
			return obj;
		}
		menu_title(){
			return "Idle";
